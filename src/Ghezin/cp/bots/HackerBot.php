...
class HackerBot extends Human{
	
	const ATTACK_COOLDOWN=2;
	const REACH_DISTANCE=4.5;
	const LOW_REACH_DISTANCE=0.8;
	const ACCURACY=85;
	const POT_CHANCE=960;
	const POT_WAIT=20 * 3;//3 seconds
	
	public $name="Hacker Bot";
	public $target=null;
	public $duel=null;
