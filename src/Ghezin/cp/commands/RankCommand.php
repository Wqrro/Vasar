...
use Ghezin\cp\forms\{SimpleForm, CustomForm};
use Ghezin\cp\Core;
use Ghezin\cp\Utils;
...
class RankCommand extends PluginCommand{
	...
	public function __construct(Core $plugin){
		...
		$this->plugin=$plugin;
		$this->setPermission("cp.command.rank");
	}
	public function execute(CommandSender $player, string $commandLabel, array $args){
		if(!$player->hasPermission("cp.command.rank")){
	...
	public function rankForm(Player $player):void{
		...
		$form->setTitle("Select a Rank Variation");
	...
	public function rankInfoForm(Player $player, string $rank):void{
		...
		$form->setTitle("Players With ".$this->rank." Rank");
