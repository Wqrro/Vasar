...
class Kits{
	...
	public static function sendKit(Player $player, $kit){
		switch($kit){
			...
			$unranked=Item::get(Item::DIAMOND_SWORD, 0, 1);
			...
			$player->getInventory()->setItem(3, $ffa);
			...
			//$player->getInventory()->setItem(3, $botduels);
