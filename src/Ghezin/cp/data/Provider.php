...
class Provider{
	...
	/*public function rankExists($player){
		if($player instanceof Player) $player=$player->getName();
		if(!$result=$this->mysql->query("SELECT * FROM rank WHERE player='".$this->mysql->real_escape_string($player)."'")){
