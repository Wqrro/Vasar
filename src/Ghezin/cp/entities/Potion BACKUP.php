...
use Ghezin\cp\items\Splash;
use Ghezin\cp\Utils;

class Potion extends Projectile{
	...
	public function __construct(Level $level, CompoundTag $nbt, ?Entity $owner=null){
		...
		$this->handleMotion($this->motion->x, $this->motion->y, $this->motion->z, -0.35, 1.3);
	}
